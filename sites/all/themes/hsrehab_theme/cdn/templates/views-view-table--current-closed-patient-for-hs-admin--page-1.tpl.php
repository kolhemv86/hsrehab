...
<table <?php if ($classes) { print 'class="'. $classes . '" '; } ?><?php print $attributes; ?>>
  ...
  <?php if (!empty($header)) : ?>
    ...
    <thead>
      ...
      <tr>
		...
		<td><b>Clinic & Clinician assigned</b></td>
  ...
  <?php //echo "<pre>"; print_r($rows); ?>
	...
	?>
	  ...
	  <td><?php echo $rows[$i]['name_1']; ?></td>
	  <td><?php echo $rows[$i]['field_assign_to_a_clinic']; ?> / <?php echo $rows[$i]['field_assign_to_a_staff_pat']; ?></td>
	  
	  <td><?php echo $rows[$i]['field_patient_status']; ?></td>
	  <td><?php echo $rows[$i]['edit_node']; ?></td>
