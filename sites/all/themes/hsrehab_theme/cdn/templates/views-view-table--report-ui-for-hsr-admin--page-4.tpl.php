...
<?php //echo "<pre>"; print_r($rows); //exit; ?>
  ...
  <tbody>
	...
	?>
	  ...
	  <td><?php echo $rows[$i]['field_select_auditor']; ?></td>
	  <td><?php echo $rows[$i]['type']; ?></td>
	  <td>

	  <a href="create/ochpdf/<?php echo $rows[$i]['nid_1']; ?>" class="btn btn-xs btn-success">View html</a>

<a href="send/ochmail/<?php echo $nid = $rows[$i]['nid_1']; ?>/<?php echo $objnode->uid; ?>" class="btn btn-xs btn-success">Send</a>
