...
<?php //echo "<pre>"; print_r($rows); //exit; ?>
  ...
  <tbody>
	...
	?>
      ...
      <tr> 
	  <td>HSR1<?php echo $rows[$i]['field_ml_disrep_patient_infos']; ?></td>
	  <td><?php echo $rows[$i]['field_ml_disrep_patient_infos_1']; ?></td>
	  ...
	  <td><?php echo $rows[$i]['field_ml_disrep_clinician_name']; ?></td>
	  <td><?php echo $rows[$i]['type']; ?></td>
	  <td>

	  <a href="create/pdf/<?php echo $rows[$i]['nid_1']; ?>" class="btn btn-xs btn-success">View Html</a>

	  <a href="send/mail/<?php echo $nid = $rows[$i]['nid_1']; ?>/<?php echo $objnode->uid; ?>" class="btn  btn-xs btn-success">Send</a>
